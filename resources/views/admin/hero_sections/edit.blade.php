                ...
                <form method="POST" action="{{ route('admin.hero_sections.update', $hero_section) }}"
                    ...
                    <div>
                        ...
                        <x-text-input id="heading" class="block mt-1 w-full" type="text" name="heading" required
                            value="{{ $hero_section->heading }}" autofocus autocomplete="heading" />
                    ...
                    <div class="mt-4">
                        <x-input-label for="subheading" :value="__('Sub Heading')" />
                    ...
                    <div class="mt-4">
                        ...
                        <x-text-input id="path_video" class="block mt-1 w-full" type="text" name="path_video"
                            value="{{ $hero_section->path_video }}" autofocus autocomplete="path_video" />
